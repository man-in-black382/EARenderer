...
- (void)mouseDown:(NSEvent *)event {
    [self notifyInputWithMouseEvent:event action:EARenderer::Input::SimpleMouseAction::PressDown];
}
...
- (void)mouseUp:(NSEvent *)event {
    [self notifyInputWithMouseEvent:event action:EARenderer::Input::SimpleMouseAction::PressUp];
}
...
- (void)mouseDragged:(NSEvent *)event {
    [self notifyInputWithMouseEvent:event action:EARenderer::Input::SimpleMouseAction::Drag];
}
...
- (void)mouseMoved:(NSEvent *)event {
    [self notifyInputWithMouseEvent:event action:EARenderer::Input::SimpleMouseAction::Move];
}
