    ...
    */
    ...
    private:
        ...
        inline RecordType(const DataType &pData)
                : mData(pData), mParent(0), mLeftChild(0), mRightChild(0), mColor(eRed), mBlackDepth(0) {
        }
...
public:
    ...
    inline FbxRedBlackTree(const FbxRedBlackTree &pTree) : mRoot(0), mSize(0), mAllocator(sizeof(RecordType)) {
        operator=(pTree);
    }
