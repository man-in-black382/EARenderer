...
//        setBufferTexture(uint32_constant<ctcrc32("uProbeOcclusionMapsAtlas")>, atlas);
//    }

    void GLSLProbeOcclusionRendering::setProbeOcclusionMapAtlasOffsets(const GLUInteger2BufferTexture<glm::uvec2> &offsets) {
        setBufferTexture(uint32_constant<ctcrc32("uProbeOcclusionMapAtlasOffsets")>, offsets);
    }
