...
#pragma mark - Setters
    ...
    void GLSLDirectionalExponentialShadowMap::setMVPMatrix(const glm::mat4& matrix) {
        glUniformMatrix4fv(uniformByNameCRC32(ctcrc32("uModelViewProjectionMatrix")).location(), 1, GL_FALSE, glm::value_ptr(matrix));
    }
